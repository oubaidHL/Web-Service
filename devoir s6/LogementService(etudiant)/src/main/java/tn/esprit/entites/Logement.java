...
@ApiModel(description = "Logement Model")
public class Logement {
	...
	public Logement(int reference, String adresse, String deleguation, String gouvernorat, Type type,
	...
	@ApiModelProperty(value= "unique ref")
